...
<ul>
    ...
    <li>Select <b>Create Competition</b>.</li>
</ul>
...
<ul>
    ...
    <li>Select <b>Add New Stage</b></li>
</ul>
...
<ul>
    ...
    <li>Only the best two-from-three rounds count, so we add the <b>Use top n</b> rule with a value of 2.</li>
</ul>
...
<ul>
    ...
    <li>Select <b>Add New Round</b></li>
</ul>
 ...
 <ul>
    ...
    <li>For this example, we want the best raw-score normalised to 1000.  Select <b>Best Score</b> in the normalisation pull-down, and enter 1000 in the <b>Normalise to</b> box.</li>
 </ul>
...
<ul>
    <li>Enter the name or email address of the FCScore user and click <b>Search</b>.</li>
</ul>
...
<ul>
    <li>If your competitor is already an FCScore User, click on them in the search results and then click <b>Add</b>.</li>
    <li>If your competitor is not an FCScore User, click on <b>Can't find your user? Create a new one here</b> to bring up the new user pop-up.</li>
</ul>
...
<ul>
    ...
    <li>To change the running order, click instead on <b>Running Order</b>.  To begin, each competitor has the same default running order in each round:</li>
</ul>
<img src="{base}/figure16.png">

<ul>
    <li>Click on Stage 1 and select <b>Running Order</b> in the pop-up.</li>
</ul>
...
<h4>Upload a Flight</h4>
 <ul>
    ...
    <li>Before uploading, select the <b>Link to competition after upload</b> checkbox.</li>
 </ul>
 <img src="{base}/figure22.png">
 
 <ul>
    <li>Click the <b>Select Competition</b> button.  A pop-up appears with the competitions you can upload to.  Click <b>Select</b> on the correct competition:</li>
 </ul>
 <img src="{base}/figure23.png">

 <ul>
    <li>You can now select the round and competitor for the flight, and click <b>Upload</b>.</li>
 </ul>
...
<h4>Assign an Already Uploaded Flight</h4> 
 ...
 <ul>
    <li>Click on the <b>…</b> for competitor and round you want to assign a flight for.  Select <b>Link Flight from DB</b>.</li>
 </ul>
 <img src="{base}/figure26.png">

 <ul>
    <li>A list of flights is shown for the competitor.  Click <b>Link</b> for the desired flight.</li>
 </ul>
...
<h4>Close the Round</h4>
 ...
 <ul>
    <li>Click on the Round heading and click <b>Close</b> in the pop-up.</li>
 </ul>
...
<h2>Example 2 - An In-Person Competition with Preliminary and Final Stages</h2>
 ...
 <ul>
    ...
    <ul>
        <li>The result from the preliminary stage will be included as the first round.</li>
...
<h3>Create the Preliminary Stage</h3>
 ...
 <ul>
    <li>The stage results are normalised to 1000; for this we set the normalisation to <b>Best Score</b>.</li>
    <li>Only the best two rounds for each competitor shall count to the stage result.  For this we set <b>Use top n</b> to 2.</li>
    <li>Only the top five pilots will progress at the end of this stage. For this we use the <b>Progress top n</b> feature and set it to 5.</li>
 </ul>
...
<h3>Create the Final Stage</h3>
 ...
 <ul>
    ...
    <li>For the competitors progressing to this stage, the scores from the Preliminary Stage are not accumulated into the result (instead, they are included as the first round). For this, we select <b>Restart scoring from this stage</b>.</li>
    <li>Only the best two rounds count towards the result, so we use the <b>Use top n</b> feature set to 2.</li>
 </ul>
...
<h4>Round 1</h4>
 <p>This round is not a flown round, instead it contains the scores from the Preliminary Stage.  For this, we use the <b>Score from previous stage</b> feature, selecting the Preliminary Stage:</p>
...
<p>This competition will run as follows:</p>
 <ul>
    ...
    <li>Each competitor may upload only one flight and may not subsequently replace that flight.</li>
...
<h3>Create the Competition</h3>
 ...
 <ul>
    <li>To allow pilots to enter themselves, we select <b>Allow pilots to enter</b>.</li>
    <li>To allow pilots to add their own flight, we select <b>Allow pilots to link their own flights</b>.</li>
 </ul>
...
<h3>Add a Stage</h3> 
 ...
 <ul>
    <li>To ensure competitors fly whilst the round is open, select <b>Must boot whilst round is open</b>.</li>
    <li>To ensure that the competitors upload whilst the comp is open and with 24 hours of flying, we:</li>
    <ul>
        <li>Select <b>Must upload whilst round is open</b></li>
        <li>Set <b>upload within (hours from boot)</b> to 24</li>
    </ul>
    <li>To ensure that each competitor can only upload one flight, select <b>Prevent flight overwrite</b>.</li>
 </ul>
 <img src="{base}/figure39.png">

<h3>Add a Round</h3>
 <p>Following the same steps as Example 1, add a Round.  The only setting to be made here is the normalisation, which we set to <b>Best Score</b> to 1000.</p>
 <img src="{base}/figure40.png">

<h3>Run the Competition</h3>
 <p>This is as simple as opening the round by clicking on it and selecting <b>Open</b>.</p>
 <img src="{base}/figure41.png">

 <p>Your competition will appear in the competitions list, and Competitors can now add themselves by clicking the <b>Enter</b> button. </p>
 <img src="{base}/figure42.png">

 <p>They will then appear in the competition.</p>
 <img src="{base}/figure43.png">

 <p>To add a flight, they can link it as they upload it, or click the ellipsis (<b>…</b>) by their name in the round to link an already uploaded flight (see Example 1).</p>
 <p>Once you are ready to finish the competition, simply close the round by clicking it and selecting <b>Close</b>.</p>
...
<thead>
  ...
  <tr>
    <td><b>Restart Scoring From this Stage</b></td>
...
<thead>
  ...
  <tr>
    <td><b>Score from Previous Stage</b></td>
...
<thead>
  ...
  <tr>
    <td><b>Best Score N</b></td>
    <td>Normalisation is applied such that the best score is normalised to N.</td>
  </tr>
  <tr>
    <td><b>Average Score N</b></td>
    <td>Normalisation is applied such that a raw score equal to the average of all scores would be normalised to N.</td>
  </tr>

<thead>
    <tr>
        <th colspan="2">Running Order Rotation Options</th>
    </tr>
</thead>
  <tr>
    <td><b>Continue from previous stage</b></td>
    <td>The first round of this stage will be taken from the last round of the previous stage (with rotation applied).</td>
  </tr>
  <tr>
    <td><b>Randomise first round</b></td>
    <td>The first round of this stage will have a random running order applied.</td>
  </tr>
  <tr>
    <td><b>Rotate by N</b></td>
    <td>The running order will be shifted down by N pilots between rounds.</td>
  </tr>
